...
from src.providers.pool_manager import ProviderManager
...
class ASRHub:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.operators_config = self.config.operators
    ...
    def _show_startup_message(self):
        ...
        system_info = [
            ...
            f"VAD：{'啟用' if self.operators_config.vad.enabled else '停用'}",
            f"降噪：{'啟用' if self.operators_config.denoise.enabled else '停用'}",
        ]
        ...
        operator_features = {
            ...
            "VAD": '✓' if self.operators_config.vad.enabled else '✗',
            "Denoise": '✓' if self.operators_config.denoise.enabled else '✗',
        }
        
        logger.block("OPERATOR FEATURES", operator_features, border_style="yellow")
